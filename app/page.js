    ...
    <div className="page">
                ...
                >
                  ...
                  <span className="rowTiers">
                    {p.entries.map((r) => {
                      ...
                      return (
                        <span className="tierBadge" key={`${r.gamemode}:${r.rank}`} style={{ color }} title={`${displayMode(r.gamemode)} Tier ${tier} — ${pts} pont`}>
                          ...
                          <span className="tierTooltip">
                            {displayMode(r.gamemode)} Tier {tier}
                    ...
                    <div className="detailRight">
                      ...
                      <div className="detailStats">
                        ...
                        <div className="detailStat">
                          ...
                          <span className="detailStatLabel">Tier</span>
                        </div>
                        <div className="detailStat">
                        ...
                        {p.entries.map((r) => {
                          ...
                          return (
                            <div className="detailTier" key={`${r.gamemode}:${r.rank}`}>
                              ...
                              <span className="detailTierRank" style={{ color }}>Tier {tier}</span>
                            </div>
                          );
                        })}
                      </div>
      ...
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        .tabBtn.active {
          background: rgba(37,150,190,0.15); color: var(--text);
        ...
        .playerRow:hover {
          ...
          box-shadow: 0 4px 20px rgba(0,0,0,0.3), 0 0 0 1px rgba(37,150,190,0.15);
        }
